...
public class Parser {
    ...
    public Expression parse(String s) throws MathLogicException {
        ...
        if (!"".equals(result.rest)) {
            throw new MathLogicException("Error: couldn't parse \"" + result.rest + "\"");
        }
    ...
    private Result brackets(String s) throws MathLogicException {
        ...
        if (ch == '(') {
            ...
            if (!r.rest.isEmpty() && r.rest.charAt(0) == ')') {
                ...
                throw new MathLogicException("Error: couldn't parse \"" + r.rest + "\"");
            }
            return r;
        }
    ...
    private Result variable(String s) throws MathLogicException {
        ...
        if (res.isEmpty()) {
            throw new MathLogicException("Error: couldn't parse \"" + s + "\"");
        }
